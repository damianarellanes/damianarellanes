/**************************** RESEARCH INTERESTS ****************************/
var researchInterestsDesc = 'My core research focuses on the area of <i>software engineering for distributed systems</i> and, more specifically, on autonomic models of computation for the Internet of Things (IoT).<br/><br/>To date, I have discovered the notion of <b>workflow spaces</b> which are computational structures that underpin the foundations of <i>algebraic composition</i>. This notion lead me to the development of an <b>algebra of control flow spaces</b> that allows the compositional construction of (variable) service-oriented IoT systems.<br/><br/>Currently, I investigate the fundamental semantics of autonomicity in algebraic service-oriented models for tackling the scale and the complexity of IoT. I have a strong interest in the theory of self-* properties (e.g., self-composition, self-optimisation, self-reconfiguration, etc.) for realising autonomous IoT software systems. Like any other branch of theoretical Computer Science, this theory is grounded in philosophy and it is ultimately relevant to applied computing in diverse IoT domains (e.g., Smart Cities, End-User Programming and Connected Health).';
