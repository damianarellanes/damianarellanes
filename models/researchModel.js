/**************************** RESEARCH INTERESTS ****************************/
var researchInterestsDesc = 'My work is in <b>Theoretical Computer Science</b>, a field grounded in mathematical rigour aimed at establishing the foundations of computer science. I am particularly interested in the logical structure and fundamental nature of computation itself. Accordingly, my search and research have been focused on uncovering/extracting the theoretical foundations of <b>Algebraic Composition</b> for <b>Models of High-Level Computation</b> (MHCs), mainly through the lens of categorical semantics. For an accessible introduction to MHCs, see <a target="_blank" href="https://arxiv.org/pdf/2402.02602.pdf">this paper</a>.<br/><br/>As part of my scientific programme, I have previously discovered the notion of workflow spaces for algebraically constructing variable control-driven computing devices. With the foundations of cellular automata and category theory, I have <a target="_blank" href="papers/Composition_Machines.pdf">demonstrated</a> that complex spaces of sequential computing devices can emerge from simple rules in the form of abstract categories. More recently, I discovered a <a target="_blank" href="https://arxiv.org/pdf/2309.06397">category-theoretic framework</a> for describing high-level control-driven computation (in a compositional setting) with well-defined algebraic operators built upon colimit semantics. This framework, referred to as <i>The Computon Model</i>, has been <a target="_blank" href="https://arxiv.org/pdf/2506.22687">proved</a> to be more computationally powerful than any uniform model of computation such as Turing machines, partial recursive functions or the lambda calculus.<br/><br/><center style="color: #000000; font-size: larger; font-weight: bold">My long-term research agenda revolves around <a target="_blank" href ="https://damianarellanes.github.io/computons-website/">The Computon Model</a>, aiming to provide a foundational framework for specifying and reasoning about MHCs via categorical semantics. The framework intends to be universal to apply across multiple domains, including AI and distributed systems.<center/>'//My work on algebraic models has found applications mainly in automated software engineering for supporting the compositional construction of complex software systems via algebraic operators. In this regard, I have demonstrated that these operators can enable automatic synthesis, transformation and adaptation of software at the model-level, particularly in dynamic and distributed environments such as the Internet of Things.//<br/><br/>By delving into the realm of Theoretical Computer Science, I aim to push the boundaries of our understanding of computation and lay the groundwork for future advancements in the field. Through my research, I hope to contribute to the ongoing quest for a deeper comprehension of the fundamental principles that underlie the world of computation. In this industry-dominated world, we should not forget that there is no practice without foundations. My work is not career-focused but scientific minded!';
...
var opub3 = {
	title: '',
	body: [
	    {type: 'text', content: 'Damian Arellanes. <a style="color:#000a56" target="_blank" href="https://arxiv.org/pdf/2309.06397">Compositional Separation of Control Flow and Data Flow</a>. Journal of Logical and Algebraic Methods in Programming, 2026.'}
	]
};
var opub4 = {
	title: '',
...
var opub5 = {
	title: '',
	body: [
	    {type: 'text', content: 'Damian Arellanes. <a style="color:#000a56" target="_blank" href="https://arxiv.org/pdf/2506.22687">Compositional Control-Driven Boolean Circuits</a>. In Proceedings of the 22nd International Conference on Relational and Algebraic Methods in Computer Science (RAMICS), 2026.'}
	]
};
var opub6 = {
	title: '',
...
var pubs = {
	...
	body: [
	    ...
	    { type: 'list', listType: 'ul', content: [opub3,opub6,opub5,opub4,opub1] }
	]
};
