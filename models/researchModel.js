/**************************** RESEARCH INTERESTS ****************************/
var researchInterestsDesc = 'My core research focuses on the area of software engineering for distributed systems and, more specifically, on autonomic models of computation for the Internet of Things (IoT). Currently, I investigate the fundamental semantics of autonomicity in algebraic service-oriented models for tackling the scale and the complexity of IoT. I have a strong interest in the theory of computation for enabling both self-* properties (e.g., self-healing, self-optimisation, self-reconfiguration, etc.) and the compositional construction of autonomous IoT software systems. This theory is grounded in philosophy, and it is ultimately relevant to applied computing in diverse IoT domains (e.g., Smart Cities, End-User Programming and Connected Health).';
