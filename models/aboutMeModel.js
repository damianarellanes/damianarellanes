/**************************** RESUME ****************************/
var resumeDesc = 'I am a tenure-track Professor in Computer Science at Lancaster University (Top 10 UK University), with a prime focus on autonomic software models for the Internet of Things (IoT). To date, my research has received a number of awards, including the Best Paper Award at the International Conference on Internet of Things (ICIOT 2018), the Nick Sanders Kickstarter Fund (Masood Enterprise Centre), the second prize in the Next Big Thing competition (Manchester, UK) and the second prize for the Carole Goble Medal (The University of Manchester).<br/><br/><b>I am currently accepting PhD proposals<b/> in the areas of: (i) Program Synthesis, (ii) Autonomous/Self-Adaptive Software Systems, (iii) Models of computation for the Internet of Things, and (v) Foundational Semantics for Service-Oriented Computing. Please email me your CV, academic transcripts and a research proposal (3-4 pages).<br/><p style="color:red">***We have PhD studentships available for UK/International students (covering fees and living expenses)***<p style="color:red">';
