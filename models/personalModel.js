...
var personalIntro = { 
	...
	body: [
		...
		type: 'text',
		content:
		    '<i>"The true nature of things is more readily apprehended through the eyes of the theoretician rather than by a purely mechano-empirical epistemic stance. In the spirit of Hellenic thought, "intuition over observation" is key to the formulation of universal principles directly extracted from the world of ideas. Mathematics, as a plurality of formal languages, does not precede intuition but rather disciplines it, allowing us to describe what it is or what we observe in a precise manner. It is because of this that semantics retains a permanent value in the development of abstract thought towards a (potentially) asymptotic proximity to reality and truth." D. Arellanes (2020)</i>'  
